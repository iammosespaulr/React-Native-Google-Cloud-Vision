...
class Pie extends React.Component {
  ...
  render() {
    ...
    return (
      <View width={this.props.width} height={this.props.height+18}>
        <Surface width={this.props.width} height={this.props.height+18}>
           <Group x={x} y={y}>
           {
        ...
        <View style={{position: 'absolute', top:margin, left: 2*margin + this.props.pieWidth}}>
          {
            this.props.data.map( (item, index) =>
            {
              ...
              return (
                <TouchableOpacity style={{ margin: 4}} key={index} onPress={() => this._onPieItemSelected(index)}>
                  <View>
